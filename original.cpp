...
int main()
{
	...
	do {
		system("cls");
		getZeroXY(10, 5); std::cout << " -------------------------- ";
		getZeroXY(10, 6); std::cout << " |      Flappy Bird       | ";
		getZeroXY(10, 7); std::cout << " --------------------------";
		getZeroXY(10, 9); std::cout << "1. Start Game";
		getZeroXY(10, 10); std::cout << "2. Instructions";
		getZeroXY(10, 11); std::cout << "3. Quit";
		getZeroXY(10, 13); std::cout << "Select option: ";
		char option = getche();
